function Footer() {
  return (
    <footer class="mx-auto bg-slate-800 text-center text-neutral-600 dark:text-neutral-200 lg:text-left font-mulish">
      <div class="container mx-auto py-10 text-center md:text-left ">
        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div class="">
            <div class="flex flex-row mb-10">
              <div class="text-white text-[48px] font-mulish font-extrabold">
                team
              </div>
              <div className={` h-3 w-3 bg-[#0ebef2] mt-[24px] `}></div>
            </div>
            <a
              href="#!"
              class=" mt-6 mr-6 text-neutral-600 dark:text-neutral-200 gap-2 flex flex-row "
            >
              <svg
              ...
              <p style={{ color: "#E5E5E5" }} class="text-lg">
                Instagram
              </p>
            </a>
            <a
          ...
          <div class="">
            <h6 class="mb-10 flex justify-center font-bold md:justify-start">
              Use Cases
            </h6>
            <p class="mb-4">
          ...
          <div>
            <h6 class="mb-10 flex justify-center font-semibold md:justify-start">
            ...
            <div class="mb-6 md:mr-auto">
              <button
                type="button"
                class=" text-sky-400 inline-block bg-slate-50 rounded bg-primary px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]"
              >
                Subscribe
              </button>
            </div>
